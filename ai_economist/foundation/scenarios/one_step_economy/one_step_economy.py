...
class OneStepEconomy(BaseEnvironment):
    ...
    def set_offer(self):
        import json
        import os as _os
        _root = _os.path.dirname(_os.path.dirname(_os.path.dirname(_os.path.dirname(_os.path.dirname(__file__)))))
        _profiles_path = _os.path.join(_root, 'data', 'profiles.json')
        with open(_profiles_path, 'r') as file:
